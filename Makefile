...
TST_OBJS += tests/bin/source/detect.o
TST_OBJS += tests/bin/source/target_scan.o
TST_OBJS += tests/bin/tests/detect_tests.o
...
help:
	...
	@echo "                        (no target support, no gdb-server, detect SWD interface)"
